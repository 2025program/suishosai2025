...
export const festivalItems: FestivalItem[] = [
    ...
    { id: 6, title: '翠嵐病棟～覚悟を持って入院してください～', reading:"すいらんびょうとう～かくごをもってにゅうがくしてください～", attributes: [Sun], floor: 4, x: 683, y: 500, class: "1-6", location: "1-6" },
    ...
    { id: 9, title: 'おばけたたき', reading:"", attributes: [Sun], floor: 4, x: 533, y: 500, class: "1-9", location: "1-9" },
    //2年
    { id: 10, title: 'をかしなお菓子', reading:"かし", attributes: [Sun, Soup], floor: 1, x: 111, y: 111, class: "2-1", location: "3-7" },
    ...
    { id: 22, title: 'あつまれ！かとひろの森', reading:"もり", attributes: [Sun], floor: 1, x: 111, y: 111, class: "3-6", location: "3-3" },
    { id: 23, title: 'コマーツ魔法学校', reading:"こまーつまほうがっこう", attributes: [Sun], floor: 1, x: 111, y: 111, class: "3-7", location: "3-5" },
    { id: 24, title: 'えじえじのはちみつのりハント', reading:"はんと", attributes: [Sun], floor: 1, x: 111, y: 111, class: "3-8", location: "3-6" },
    { id: 25, title: 'DESCAFE Excella', reading:"ですかふぇ えくせら", attributes: [Sun], floor: 1, x: 111, y: 111, class: "3-9", location: "3-2" },
    //部活・委員会・有志 
    { id: 26, title: '圧倒的IT研究部', reading:"あっとうてきあいてぃーけんきゅうぶあっとうてきあいてぃーけんきゅうぶ", attributes: [Sun], floor: 1, x: 111, y: 111, class: "IT研究部", location: "コンピュータ室" },
    ...
    { id: 30, title: 'わくわく！バスケットラックアウト', reading:"", attributes: [Sun], floor: 1, x: 111, y: 111, class: "バスケットボール部", location: "3-8" },
    { id: 31, title: 'みねとひあさのかみかくし', reading:"", attributes: [Sun], floor: 1, x: 111, y: 111, class: "バドミントン部", location: "1-5" },
    { id: 32, title: 'ハンドボール　水風船', reading:"みずふうせん", attributes: [Sun], floor: 1, x: 111, y: 111, class: "ハンドボール部", location: "部室棟" },
    { id: 33, title: 'ベーゴマ体験', reading:"たいけん", attributes: [Sun], floor: 1, x: 111, y: 111, class: "ベーゴマ愛好会", location: "書道室" },
    { id: 34, title: '翠翔祭ライブ', reading:"すいしょうさい", attributes: [Sun], floor: 1, x: 111, y: 111, class: "ポピュラーソング部", location: "テキサス" },
    ...
    { id: 37, title: '王手！　盤上の祭典in翠嵐', reading:"おうて！　ばんじょうのさいてんいｎすいらん", attributes: [Sun], floor: 1, x: 111, y: 111, class: "棋道部", location: "生物室" },
    ...
    { id: 43, title: 'あつまれすうがく村', reading:"むら", attributes: [Sun], floor: 1, x: 111, y: 111, class: "数学研究部", location: "化学実験室" },
    { id: 44, title: 'のびるくん本舗', reading:"ほんぽ", attributes: [Sun], floor: 1, x: 111, y: 111, class: "生徒会", location: "1-3" },
    ...
    { id: 51, title: 'まんけん2025', reading:"", attributes: [Sun], floor: 1, x: 111, y: 111, class: "漫研", location: "1-5" },
    ...
    { id: 56, title: '［革命］学生一人で企画やってみたPt(n+1)', reading:"［かくめい］がくせいひとりできかくやってみた", attributes: [Sun], floor: 1, x: 111, y: 111, class: "有志", location: "2階渡り廊下" },
    ...
    { id: 62, title: 'ミントブルー', reading:"みんとぶるー", attributes: [Sun, Drum], floor: 1, x: 111, y: 111, class: "吹奏楽部", location: "野外ステージ" },
